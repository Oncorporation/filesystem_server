...
This document explains how to publish the filesystem-server to the MCP Registry at modelcontextprotocol.info.

## Overview

The filesystem-server is configured to be automatically published to both PyPI and the MCP Registry using GitHub Actions whenever you create a new version tag.
...
- Package type: `pypi`
- Package identifier: `filesystem-server`
